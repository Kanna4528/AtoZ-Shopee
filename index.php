...
$qer2="select * from products2";	
$qes2=mysqli_query($con,$qer2);
$list2=array();
while($row= mysqli_fetch_assoc($qes2)){
    $list2[]=$row;
}
?>
<!DOCTYPE html>
		...
		<div class="header-two navbar navbar-default"><!--header-two-->
			<div class="container">
				...
				<div class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".7s">
					<h1><a href="index.php">AtoZ <b>Shoppe</b><span class="tag">Everything for Modern world </span> </a></h1>
				</div>
		...
		<div class="container">
			<div class="footer-info">
				<div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".5s">
					<h4 class="footer-logo"><a href="index.php">AtoZ <b>Shoppe</b> <span class="tag">Everything for Modern world </span> </a></h4>
					<p>© 2017 AtoZ Shoppe . All rights reserved | Design by <a href="http://w3layouts.com" target="_blank">Kanna4528</a></p>
				</div>
