				...
				<nav class="navbar" role="navigation">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav top-nav-info">
							...
							<li class="dropdown grid">
								<a href="#" class="dropdown-toggle list1" data-toggle="dropdown">Men<b class="caret"></b></a>
								<ul class="dropdown-menu multi-column multi-column2">
									<div class="row">
										<div class="col-sm-3 menu-grids">
											<h4>New Arrivals</h4>
											<ul class="multi-column-dropdown">
												<li><a class="list" href="products.php">Jeans</a></li>
												<li><a class="list" href="products.php">Tshirts</a></li>
												<li><a class="list" href="products.php">Formals</a></li>
												<li><a class="list" href="products.php">Nightwear</a></li>
												<li><a class="list" href="products.php">Casual Shoes</a></li>
												<li><a class="list" href="products.php">Watches</a></li>
											</ul>
										</div>																		
										<div class="col-sm-3 menu-grids">
											<h4>Men</h4>
							...
							<li class="dropdown grid">
								<a href="#" class="dropdown-toggle list1" data-toggle="dropdown">Women<b class="caret"></b></a>
								<ul class="dropdown-menu multi-column multi-column2">
									<div class="row">
										<div class="col-sm-3 menu-grids">
											<h4>New Arrivals</h4>
											<ul class="multi-column-dropdown">
												...
												<li><a class="list" href="products.php">NightWear</a></li>
												<li><a class="list" href="products.php">Formals</a></li>
												<li><a class="list" href="products.php">Footwear</a></li>
